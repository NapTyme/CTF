...
*   **Research:** I searched for "how to check user permissions in Linux" and found the `sudo -l` command, which is used to find commands that the current user is able to run with root privelages.
